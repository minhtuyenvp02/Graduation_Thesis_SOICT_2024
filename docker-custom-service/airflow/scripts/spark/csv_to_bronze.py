...
if __name__ == "__main__":
    ...
    bronze_processing.csv_to_bronze(source_csv=LOCATION_CSV_PATH, target_table_name="location",
                         id_option=False)
    bronze_processing.csv_to_bronze(source_csv=DPC_BASE_NUM_CSV_PATH,
